...
void test_is_receiver_of()
{
  {
    // test not a receiver
    static_assert(!cusend::is_receiver_of<not_a_receiver, void>::value, "Expected false.");
  }

  {
    // test a receiver of void with void
    static_assert(cusend::is_receiver_of<my_receiver_of_void, void>::value, "Expected true.");
  }
...

  {
    ...
    static_assert(!cusend::is_receiver_of<my_receiver_of_void, int>::value, "Expected false.");
  }

  {
    // test a receiver of int with int
    static_assert(cusend::is_receiver_of<my_receiver_of_int, int>::value, "Expected true.");
  }
...

  {
    ...
    static_assert(!cusend::is_receiver_of<my_receiver_of_int, void>::value, "Expected false.");
  }

  {
    // test a receiver of either with void
    static_assert(cusend::is_receiver_of<my_receiver_of_either, void>::value, "Expected true.");
  }
...

  {
    ...
    static_assert(cusend::is_receiver_of<my_receiver_of_either, int>::value, "Expected true.");
  }
